...
<?php
                    ...
                    if(isset($_POST['submit']))
                    {
                        ...
                        $sql = "INSERT INTO `template_master`(`Temp_Head_Name`, `Isactive`, `UpadatedDate`) VALUES ('$temp_name',true,STR_TO_DATE('$date','%m%d%y'))";
...
<body class="o-page">
        ...
        <main class="o-page__content">
            <header class="c-navbar">
                ...
                <h2 class="c-navbar__title u-mr-auto">Add New Template</h2>
            ...
            <div class="c-card u-mb-small ">
               <form class="c-card__body col-md-6" method="post" action="">
                    <div class="c-field  u-mb-small">
                        ...
                        <input class="c-input" type="text" id="input1" placeholder="First Name" name="temp_name" required> 
                    </div>
                    ...
                    <div class="c-field has-addon-left u-mb-small">
                        ...
                        <input class="c-input" data-toggle="datepicker" id="input6" type="text" name="adddate">
                    </div>
