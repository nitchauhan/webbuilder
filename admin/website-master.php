...
<body class="o-page">
        ...
        <main class="o-page__content">
            <header class="c-navbar">
                ...
                <h2 class="c-navbar__title u-mr-auto">WebSites</h2>
                ...
                <table class="c-table c-table--zebra u-mb-small col-lg-6" id="datatable2">
                    <thead class="c-table__head">
                        <tr class="c-table__row">
                          <th class="c-table__cell c-table__cell--head">Site Name</th>
                          <th class="c-table__cell c-table__cell--head">Owner</th>                            
                          <th class="c-table__cell c-table__cell--head">Created Date</th>                            
                  ...
                  <tbody>
                    ...
                    $result = mysqli_query($db,"CALL get_website_master_view");
                    while($row = mysqli_fetch_array($result))
                    {
                        ?>

                        <tr class="c-table__row c-table__row--danger">
                            <td class="c-table__cell"><?php echo $row['site_name'] ?>

                        </td>

                        <td class="c-table__cell"><?php echo $row['owner'] ?>

                    </td>

                    <td class="c-table__cell"><?php echo $row['create_date'] ?>

                </td>

                <td class="c-table__cell">
                    <a class="c-btn c-btn--success" href="website-master-byid.php?edit=<?php echo $row['webid'] ?>">
