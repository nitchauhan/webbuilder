        ...
        <div class="o-page__sidebar js-page-sidebar">
            <div class="c-sidebar">
                ...
                <ul class="c-sidebar__list">                    
                    ...
                    <li class="c-sidebar__item">
                        <a class="c-sidebar__link" href="projects.html">
                ...
                <table class="c-table c-table--zebra u-mb-small" id="datatable2">
                    <thead class="c-table__head">
                        <tr class="c-table__row">
                          ...
                          <th class="c-table__cell c-table__cell--head">Template</th>
                          <th class="c-table__cell c-table__cell--head">Join Date</th>
                  ...
                  <tbody>
                    ...
                    $result = mysqli_query($db,"CALL get_user_master_view");
                    while($row = mysqli_fetch_array($result))
                    {
                        ...
                        <tr class="c-table__row c-table__row--danger">
                            <td class="c-table__cell"><?php echo $row['name'] ?>

                        </td>

                        <td class="c-table__cell"><?php echo $row['email'] ?>
                    ...
                    <td class="c-table__cell"><?php echo $row['join_date'] ?>

                </td>

                <td class="c-table__cell">
                    <a class="c-btn c-btn--success" href="user-master-byid.php?edit=<?php echo $row['id'] ?>">
                        <i class="fa fa-pencil-square-o u-mr-xsmall"></i>Edit
                    </a>

                    <a class="c-btn c-btn--success" href="user-master-byid.php?remove=<?php echo $row['id'] ?>">
